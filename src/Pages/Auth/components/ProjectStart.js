                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="register-login-form">
                            <h3 className="title">Register for a Project Assistance <span>Now</span></h3>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className="single-form">
                                        ...
                                        <select required {...register('category')} className='single-form' style={{border:'1px solid rgba(48, 146, 85, 0.2',width: '100%', height: '60px', padding: '0 25px', fontSize: '15px', color: '#52565b', borderRadius: '10px', background: '#fff', transition: 'all 0.3s ease 0s'}}  name='category' >
                                            ...
                                            <option value='it'>I.T Report</option>
                                            <option value='bsc'>B.Sc Project</option>
                                            <option value='msc'>M.Sc Thesis</option>
                                        </select>
                                    </div>
                                    <div className="single-form">
                                        <input required {...register('faculty')} type="text" placeholder="Faculty" />
                                    </div>
                                    <div className="single-form">
                                        <input required {...register('department')} type="text" placeholder="Department" />
                                    </div>
                                    <div className="single-form">
                                        <input required {...register('topic')} type="text" placeholder="Topic" />
                                    </div>
                                    {/* <!-- Single Form End --> */}
                                    {/* <!-- Single Form Start --> */}
                                    {/* <div className="single-form">
